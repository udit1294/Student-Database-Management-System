...
class Student:
    def __init__(self,root):  #constructor initialize
        ...
        combo_dep=ttk.Combobox(std_lbl_info_frame,font=('arial',12,'bold'),width=16,state='readonly') #create combobox for choosing values
        ...
        com_course=ttk.Combobox(std_lbl_info_frame,font=('arial',12,'bold'),width=16,state='readonly')
        ...
        com_year=ttk.Combobox(std_lbl_info_frame,font=('arial',12,'bold'),width=16,state='readonly')
        ...
        com_Semester=ttk.Combobox(std_lbl_info_frame,font=('arial',12,'bold'),width=16,state='readonly')
        ...
        id_entry=ttk.Entry(std_lbl_class_frame,font=('arial',12,'bold'),width=12)
        ...
        id_entry=ttk.Entry(std_lbl_class_frame,font=('arial',11,'bold'),width=18)
        ...
        label_roll.grid(row=1,column=0,padx=2,pady=7,sticky=W)
        roll_entry=ttk.Entry(std_lbl_class_frame,font=('arial',11,'bold'),width=11)
        ...
        label_Division.grid(row=1,column=2,padx=2,pady=7,sticky=W)
        com_Division=ttk.Combobox(std_lbl_class_frame,font=('arial',12,'bold'),width=13,state='readonly')
        com_Division['values']=('Select Division','S','A','B','C','D','E','P','F')
        com_Division.current(0)
        com_Division.grid(row=1,column=3,padx=2,pady=7,sticky=W)
        ...
        com_Gender=ttk.Combobox(std_lbl_class_frame,font=('arial',12,'bold'),width=12,state='readonly')
        ...
        Dob_entry=ttk.Entry(std_lbl_class_frame,font=('arial',11,'bold'),width=18)
        ...
        Phone_entry=ttk.Entry(std_lbl_class_frame,font=('arial',11,'bold'),width=10)
        ...
        Email_entry=ttk.Entry(std_lbl_class_frame,font=('arial',11,'bold'),width=22)
        ...
        Teacher_entry=ttk.Entry(std_lbl_class_frame,font=('arial',11,'bold'),width=15)
        ...
        Address_entry=ttk.Entry(std_lbl_class_frame,font=('arial',11,'bold'),width=30)
        ...
        btn_add=Button(button_frame,text='Save',font=('arial',12,'bold'),width=14,bg='green',fg='white',cursor='hand2')
        btn_add.grid(row=0,column=0,sticky=W,padx=1)

        btn_update=Button(button_frame,text='Update',font=('arial',12,'bold'),width=14,bg='blue',fg='white',cursor='hand2')
